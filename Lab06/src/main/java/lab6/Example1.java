...
public class Example1 {
		...
		public static void main(String[] args) {
			...
			for (Weekday day : daysArray) {
				...
				case MONDAY : System.out.println(day + " is a working day");
				break;
				case TUESDAY : System.out.println(day + " is a working day");
				break;
				case WEDNESDAY :System.out.println(day + " is a working day");
				break;
				case THURSDAY : System.out.println(day + " is a working day");
				break;
				case FRIDAY : System.out.println(day + " is a working day");
				break;
				case SATURDAY : System.out.println(day + " is a weekend");
				break;
				case SUNDAY : System.out.println(day + " is a weekend");
				break;
				default:
					break;
				}
